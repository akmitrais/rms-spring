...
import com.mitrais.khotim.rmsspring.client.models.Book;
...
public class BookController {
	...
	public BookController(RestTemplate restTemplate, @Value("${remote.uri}") final String serviceURI) throws URISyntaxException {
